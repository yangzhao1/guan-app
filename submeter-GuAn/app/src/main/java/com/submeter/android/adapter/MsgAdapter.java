...
public class MsgAdapter extends RecyclerView.Adapter<MsgAdapter.ViewHolder> {
	static String Tag = MsgAdapter.class.getSimpleName();
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        WarningMessage dataSet = (WarningMessage) mData.get(position);
        if (dataSet == null) {
            return;
        }
        ...
        setViewText(holder.titleText,dataSet.getLevel());
        setViewText(holder.contentText,dataSet.getWarnObj());
