...
import com.submeter.android.adapter.UntreatedAdapter;
...
public class UntreatedFragment extends Fragment implements IChildFragment,IUnView {
    ...
    private UntreatedAdapter adapter = null;
    ...
    private void initData() {
        ...
        if (type==1){//今日违规
            ...
            presenter.loadData("0",content.getText().toString(),isHandle,0);
        }
...
//            if (!content.getText().toString().isEmpty()){
            if (type==1){//今日违规
                presenter.onSearch("0",content.getText().toString(),isHandle,
                        1,"","");
            }else {
    ...
    public void updateView(List list) {
        ...
        if (list!=null&&list.size()!=0){
            ...
            if (adapter!=null){
                ...
                adapter = new UntreatedAdapter(parentActivity, list ,0);
