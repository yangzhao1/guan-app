...
public class CategoryGridAdapter extends BaseAdapter {
	...
	public static final int HOT_CATEGORY_ITEM_VIEW = 0;
	...
	public CategoryGridAdapter(Context context, ArrayList<HashMap<String, Object>> data) {
		mData.addAll(data);
	...
	private View inflaterView(int viewType) {
		...
		if(viewType == RECOMMEND_BRAND_ITEM_VIEW) {
		...
		} else if(viewType == HOT_CATEGORY_ITEM_VIEW) {
			view = mLayoutInflater.inflate(R.layout.item_category_commodity_category, null);
			viewHolder.imageView = (SimpleDraweeView)view.findViewById(R.id.image_view);
			viewHolder.imageView.getLayoutParams().width = imageWidth;
			viewHolder.imageView.getLayoutParams().height = imageHeight;
