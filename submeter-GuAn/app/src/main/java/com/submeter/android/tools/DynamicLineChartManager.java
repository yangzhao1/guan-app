...
public class DynamicLineChartManager {
    ...
    private List<String> weekList = new ArrayList<>(); //存储x轴
    ...
    //多条曲线
    public DynamicLineChartManager(LineChart mLineChart, List<String> names, List<Integer> colors,List<String> dateList) {
        this.lineChart = mLineChart;
        leftAxis = lineChart.getAxisLeft();
        rightAxis = lineChart.getAxisRight();
        xAxis = lineChart.getXAxis();
        this.weekList = dateList;
        initLineChart();
...
//        legend.setOrientation(Legend.LegendOrientation.VERTICAL);
        ...
        xAxis.setAxisMaximum(weekList.size()-1);
...
//                return timeList.get((int) value % timeList.size());
                ...
                if (s>weekList.size()||s==weekList.size()){
                    return "";
                }
                return weekList.get(s);
            }
        });
...
//        rightAxis.setAxisMinimum(0f);
    ...
    private void initLineDataSet(List<String> names, List<Integer> colors) {
        ...
        for (int i = 0; i < names.size(); i++) {
            ...
            lineDataSet.setAxisDependency(YAxis.AxisDependency.LEFT);
            lineDataSet.setValueTextSize(10f);
            lineDataSet.setValueFormatter((value, entry, dataSetIndex, viewPortHandler) -> entry.getY()+"");
