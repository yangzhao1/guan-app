...
import com.submeter.android.network.OkHttpStack;
...
public class Volley {
    ...
    public static RequestQueue newRequestQueue(Context context) {
        return newRequestQueue(context, new OkHttpStack(new OkHttpClient.Builder()
                /*.dns(new Dns(){
                    @Override
                    public List<InetAddress> lookup(String hostName) throws UnknownHostException {
                        String ip = OuraltApp.getInstance().getHttpdns().getIpByHostAsync(hostName);
