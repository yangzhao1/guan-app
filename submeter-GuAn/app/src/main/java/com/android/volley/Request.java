...
public abstract class Request<T> implements Comparable<Request<T>> {
     ...
     * the precess response listener is not provided here as delivery of responses
     ...
     * URL, and error listener.  Note that the precess response listener is not provided here as
